        ...
        <table className="table">
          ...
          <tbody>
            <TableHelper
              ...
              column={8}
              tableName="Blocked Staff"
            >
              {staffs.map((staff, index) => (
                <tr key={staff._id || index} className="table_row group">
                  <td className="table_outline_td">{staff?.staff_user_id}</td>
                  ...
                  <td className="table_outline_td">{staff?.full_name}</td>
                  <td className="table_outline_td">
                    <HoverTooltip
                  ...
                  <td className="table_outline_td flex gap-3 justify-center items-center ">
                    <Link
                      to={`${adminRouteLinks.staffBlocked.path}/details/${staff._id}`}
                    >
                      <ViewIconSvg />
                    </Link>
                    <Link to={`/admin/staffs/blocked/edit/${staff._id}`}>
                      <EditIconSvg />
                    </Link>
...
export default StaffBlockedTable;
