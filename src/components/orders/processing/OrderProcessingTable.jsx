...
import { formatStatusText, ViewIconSvg, WhiteEyeIconSvg } from "@/services";
            ...
            >
              {orders.map((item, index) => (
                <tr key={item._id || index} className="table_row group">
                  ...
                  <td className="table_outline_td truncate">
                    {item?.name || "-"}
                  </td>
                  <td className="table_outline_td truncate">
                    {item?.phone || "-"}
                  ...
                  <td className="table_outline_td font-medium min-w-[150px]">
                    {formatStatusText(item?.sub_status) || "-"}
                  </td>
                  <td className="table_outline_td">
                    <div className="flex justify-center">
                      {loadingStaff[item._id] ? (
                        <div className="w-[150px] h-[38px] flex items-center justify-center">
                  ...
                  <td className="table_outline_td">
                    ...
                    <Link to={`/admin/orders/processing/edit/${item._id}`}>
                        <ViewIconSvg />
                      </Link>
                    </div>
                  </td>
