              ...
              {customers.map((customer, index) => (
                <tr key={index} className="table_row group">
                  ...
                  <td className="table_outline_td group-last:!border-b-0 flex gap-3 justify-center items-center ">
                    <Link
                      to={`${adminRouteLinks.customersBlocked.path}/details/${customer._id}`}
                      title="View Details"
                    >
                      <ViewIconSvg />
                    </Link>
                    ...
                    <button
                      onClick={() => handleShowUnblockModal(customer)}
