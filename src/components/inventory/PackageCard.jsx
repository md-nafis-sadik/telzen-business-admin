    ...
    >
      <div className="flex flex-col w-full gap-3">
        ...
        <div className="flex flex-col gap-1">
          <div className="text-base md:text-lg lg:text-2xl tracking-wider">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-natural-500 text-base md:text-lg">
      ...
      <div className="flex flex-col items-end justify-end">
        <div className="text-lg md:text-xl lg:text-[28px] font-semibold">
