import MyEsimRegularHeader from "@/components/myEsims/regular/MyEsimRegularHeader";
import MyEsimRegularTable from "@/components/myEsims/regular/MyEsimRegularTable";
      ...
      >
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex w-full gap-3">
            <button className="flex-1 rounded_button_cancel" onClick={() => dispatch(closeRemoveModal())}>Cancel</button>
