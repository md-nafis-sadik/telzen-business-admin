import BrickFieldHeader from "@/components/brickField/BrickFieldHeader";
import BrickFieldTable from "@/components/brickField/BrickFieldTable";
import BrickFieldDetailsModal from "@/components/brickField/BrickFieldDetailsModal";
import RequestLoader from "@/components/shared/RequestLoader";
import { useBrickField } from "@/hooks";
  ...
  return (
    <div className="w-full flex-1 flex flex-col overflow-auto bg-white p-4 rounded-2xl">
      ...
      <Modal
        ...
        title="Are you sure you want to delete this brick field?"
        cancelButton="Cancel"
